...
the remaining skills in `../agents/skills/` (`agents-md`, `karpathy-guidelines`, `orchestrator`,
`stop-slop`) are pi's skills, vendored here so opencode, pi, and T3 Code all read one copy.
